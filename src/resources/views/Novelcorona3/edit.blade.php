        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">{{$r->fname.' '.$r->lname}}</li>
...
<section class="content">
    ...
    {!!Form::open(['action' => ['Novelcorona3Controller@update', $r->id], 'method' => 'POST']) !!}
        ...
        <div class="card-body">
            <div class="form-row">
                <div class="col-md-3 mb-1 input-group">
                    ...
                    {{Form::text('hn', $r->hn, ['class' => 'form-control', 'placeholder' => 'HN'])}}
                </div>
                <div class="col-md-3 mb-1 input-group">
                    <div class="input-group-prepend">
                        <div class="input-group-text"><i class="fas fa-id-card"></i></div>
                    </div>
                    {{Form::text('cid', $r->cid, ['class' => 'form-control', 'placeholder' => 'เลขประชาชน', 'required' => 'required'])}}
                </div>
                <div class="col-md-3 mb-1 ml-auto input-group">
                    <div class="input-group-prepend">
                        <div class="input-group-text"><i class="fas fa-code"></i></div>
                    </div>
                    {{Form::text('code', $r->code, ['class' => 'form-control', 'placeholder' => 'CODE'])}}
                </div>
            </div>

            <div class="form-row">
                <div class="col-md-3 mb-1 input-group">
                    {{Form::text('fname', $r->fname, ['class' => 'form-control', 'placeholder' => 'ชื่อ'])}}
                </div>
                <div class="col-md-3 mb-1 input-group">
                    {{Form::text('lname', $r->lname, ['class' => 'form-control', 'placeholder' => 'นามสกุล'])}}
                </div>
            ...
            <div class="form-row">
                <div class="col-md-3 mb-1 input-group">
                    ...
                    {{Form::number('age_y', $r->age_y, ['class' => 'form-control', 'placeholder' => 'ปี'])}}
                    <div class="input-group-prepend">
                        <div class="input-group-text">ปี</div>
                    </div>
                    {{Form::number('age_m', $r->age_m, ['class' => 'form-control', 'placeholder' => 'เดือน'])}}
                ...
                <div class="col-md-3 mb-1 input-group">
                    ...
                    {{Form::text('nationality', $r->nationality, ['class' => 'form-control', 'placeholder' => 'สัญชาติ'])}}
                </div>
            </div>
            <div class="form-row">
                <div class="col-md-12 mb-1 px-0">
                    <div class="input-group btn-group btn-group-toggle col-12" data-toggle="buttons">
                        <?php
                            ...
                            switch ($r->patient_type) {
                                case 1: $class[1] = 'active';  break;
                                case 2: $class[2] = 'active';  break;
                                case 3: $class[3] = 'active';  break;
                                case 4: $class[4] = 'active';  break;
                                case 5: $class[5] = 'active';  break;
                                default: NULL; break;
                            }
                        ?>
                        <label class="btn btn-outline-secondary font-weight-normal d-inline-flex align-items-center justify-content-center {{$class[1]}}">
                            <input type="radio" name="patient_type" id="patient_type_1" value="1" autocomplete="off">PUI
                        </label>
                        <label class="btn btn-outline-secondary font-weight-normal d-inline-flex align-items-center justify-content-center {{$class[2]}}">
                            <input type="radio" name="patient_type" id="patient_type_2" value="2" autocomplete="off">ผู้สัมผัสใกล้ชิดผู้ติดเชื้อ
                        </label>
                        <label class="btn btn-outline-secondary font-weight-normal d-inline-flex align-items-center justify-content-center {{$class[3]}}">
                            <input type="radio" name="patient_type" id="patient_type_3" value="3" autocomplete="off">การค้นหา/สำรวจเชิงรุก
                        </label>
                        <label class="btn btn-outline-secondary font-weight-normal d-inline-flex align-items-center justify-content-center {{$class[4]}}">
                            <input type="radio" name="patient_type" id="patient_type_4" value="4" autocomplete="off">Sentinel surveillance
                        </label>
                        <label class="btn btn-outline-secondary font-weight-normal d-flex align-items-center text-nowrap {{$class[5]}}">
                            <input type="radio" name="patient_type" id="patient_type_5" value="5" autocomplete="off">อื่นๆ&ensp;
                            {{Form::text('patient_type_text', $r->patient_type_text, ['class' => 'form-control form-control-sm', 'placeholder' => 'ระบุ'])}}
                        </label>
                    </div>
                </div>
            </div>
            <div class="form-row">
                <div class="col-md-3 mb-1 input-group">
                    ...
                    {{Form::text('occupation', $r->occupation, ['class' => 'form-control', 'placeholder' => 'อาชีพ'])}}
                </div>
                <div class="col-md-3 mb-1 input-group">
                    <div class="input-group-prepend">
                        <div class="input-group-text"><i class="fas fa-phone-alt"></i></div>
                    </div>
                    {{Form::text('telephone', $r->telephone, ['class' => 'form-control', 'placeholder' => 'เบอร์โทรศัพท์'])}}
                </div>
                <div class="col-md-6 mb-1 input-group">
                    <div class="input-group-prepend">
                        <div class="input-group-text">สถานที่ทำงาน/สถานศึกษา</div>
                    </div>
                    {{Form::text('workplace', $r->workplace, ['class' => 'form-control', 'placeholder' => 'ชื่อสถานที่ทำงานหรือสถานศึกษา'])}}
                </div>
            </div>
            <div class="form-row">
                <div class="col-md-3 mb-1 input-group">
                    ...
                    {{Form::text('address_name', $r->address_name, ['class' => 'form-control', 'placeholder' => 'ระบุชื่อสถานที่'])}}
                </div>
                <div class="col-md-1 mb-1 input-group">
                    {{Form::text('address_moo', $r->address_moo, ['class' => 'form-control', 'placeholder' => 'หมู่'])}}
                </div>
                <div class="col-md-2 mb-1 input-group">
                    {{Form::text('address_tmb', $r->address_tmb, ['class' => 'form-control', 'placeholder' => 'ตำบล'])}}
                </div>
                <div class="col-md-2 mb-1 input-group">
                    {{Form::text('address_amp', $r->address_amp, ['class' => 'form-control', 'placeholder' => 'อำเภอ'])}}
                </div>
                <div class="col-md-4 mb-1 input-group">
                    {{Form::text('address_chw', $r->address_chw, ['class' => 'form-control', 'placeholder' => 'จังหวัด'])}}
                </div>
            </div>
            <div class="form-row">
                <div class="col-md-12 mb-1 px-0">
                    <div class="input-group btn-group btn-group-toggle col-12" data-toggle="buttons">
                        ...
                        <label class="btn btn-outline-secondary font-weight-normal d-flex align-items-center text-nowrap {{$class[5]}}">
                            ...
                            {{Form::text('address_type_text', $r->address_type_text, ['class' => 'form-control form-control-sm', 'placeholder' => 'ระบุสถานที่'])}}
                        </label>
        ...
        <div class="card-body">
            <div class="row mb-1">
                <div class="col-md-4 input-group">
                    ...
                    {{Form::date('date_sick', $r->date_sick, ['class' => 'form-control', 'placeholder' => 'วันที่เริ่มป่วย'])}}
                </div>
                <div class="col-md-4 input-group">
                    <div class="input-group-prepend">
                        <div class="input-group-text">วันที่รักษาครั้งแรก</div>
                    </div>
                    {{Form::date('date_treat', $r->date_treat, ['class' => 'form-control', 'placeholder' => 'วันที่เริ่มป่วย'])}}
                </div>
                <div class="col-md-4 input-group">
                    <div class="input-group-prepend">
                        <div class="input-group-text">วันวินิจฉัยโควิด-19</div>
                    </div>
                    {{Form::date('date_diagnosis', $r->date_diagnosis, ['class' => 'form-control', 'placeholder' => 'วันที่เริ่มป่วย'])}}
                </div>
            </div>
            <div class="row mb-1">
                <div class="col-md-4 input-group">
                    ...
                    {{Form::text('hos_name', $r->hos_name, ['class' => 'form-control', 'placeholder' => 'สถานพยาบาลปัจจุบัน'])}}
                </div>
                <div class="col-md-4 input-group">
                    <div class="input-group-prepend">
                        <div class="input-group-text">จังหวัด</div>
                    </div>
                    {{Form::text('hos_chw', $r->hos_chw, ['class' => 'form-control', 'placeholder' => 'จังหวัด'])}}
                </div>
            </div>
            <div class="row mb-1">
                ...
                <div class="input-group btn-group btn-group-toggle col-9" data-toggle="buttons">
                    ...
                    ?>
                    <label class="btn btn-outline-secondary d-flex justify-content-center align-items-center font-weight-normal {{$class[1]}}">
                        <input type="radio" name="symptom" id="symptom_1" value="1" autocomplete="off"> ไม่มีอาการใดๆ
                    </label>
                    <label class="btn btn-outline-secondary d-flex justify-content-center align-items-center font-weight-normal {{$class[2]}}">
                        <input type="radio" name="symptom" id="symptom_2" value="2" autocomplete="off"> มีอาการ แต่ไม่มีอาการระบบทางเดินหายใจ
                    </label>
                    <label class="btn btn-outline-secondary d-flex text-nowrap align-items-center font-weight-normal {{$class[3]}}">
                        <input type="radio" name="symptom" id="symptom_3" value="3" autocomplete="off"> มีอาการระบบทางเดินหายใจ 
                        {{Form::text('symptom_o2sat', $r->symptom_o2sat, ['class' => 'form-control form-control-sm col-3', 'placeholder' => 'O2SAT'])}}
                    </label>
                </div>
            </div>
            <div class="row mb-1">
                ...
                <div class="input-group btn-group btn-group-toggle col-9" data-toggle="buttons">
                    <?php
                        unset($class);
                        $class = [NULL,NULL,NULL,NULL,NULL,NULL];
                        $class[1] = ($r->symptom_pneumonia == 1) ? 'active' : '';
                        $class[2] = ($r->symptom_ett == 1) ? 'active' : '';
                        $class[3] = ($r->symptom_dead == 1) ? 'active' : '';
                    ?>
                    <label class="btn btn-outline-secondary font-weight-normal {{$class[1]}}">
                        <input type="checkbox" name="symptom_pneumonia" value="1" autocomplete="off"> เป็นปอดอักเสบ
                    </label>
                    <label class="btn btn-outline-secondary font-weight-normal {{$class[2]}}">
                        <input type="checkbox" name="symptom_ett" value="1" autocomplete="off"> ใส่เครื่องช่วยหายใจ
                    </label>
                    <label class="btn btn-outline-secondary font-weight-normal {{$class[3]}}">
            ...
            <div class="row mb-1">
                <div class="col-6">
                    <div class="input-group h-100">
                        ...
                        {{Form::text('ud', $r->ud, ['class' => 'form-control h-100', 'placeholder' => 'โรคประจำตัว'])}}
                    </div>
                </div>
                <div class="col-6">
                    <div class="input-group btn-group btn-group-toggle" data-toggle="buttons">
                        <?php
                            ...
                            $class = [NULL,NULL,NULL,NULL,NULL,NULL];
                            switch ($r->pregnent) {
                                case 0: $class[1] = 'active';  break;
                                case 1: $class[2] = 'active';  break;
                                default: NULL; break;
                            }
                        ?>
                        <label class="btn btn-outline-secondary d-flex justify-content-center align-items-center font-weight-normal {{$class[1]}}">
                        ...
                        <label class="btn btn-outline-secondary d-flex text-nowrap align-items-center font-weight-normal {{$class[2]}}">
                            <input type="radio" name="pregnent" id="pregnent_2" value="1" autocomplete="off"> ตั้งครรภ์&nbsp;
                            {{Form::number('ga', $r->ga, ['class' => 'form-control form-control-sm col-3', 'placeholder' => 'GA'])}}&nbsp;สัปดาห์
                        </label>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-1">
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            <td>RT-PCR</td>
                            <td><input class="form-control" name="rtpcr_date" type="date" value="{{$r->rtpcr_date}}"></td>
                            <td><input class="form-control" name="rtpcr_sample" type="text" value="{{$r->rtpcr_sample}}"></td>
                            <td><input class="form-control" name="rtpcr_labplace" type="text" value="{{$r->rtpcr_labplace}}"></td>
                            <td>
                                <div class="input-group btn-group btn-group-toggle col-12" data-toggle="buttons">
                                    <?php
                                        unset($class);
                                        $class = [NULL,NULL,NULL,NULL,NULL,NULL];
                                        switch ($r->rtpcr_result) {
                                            case 0: $class[1] = 'active';  break;
                                            case 1: $class[2] = 'active';  break;
                                            case 2: $class[3] = 'active';  break;
                                            default: NULL; break;
                                        }
                                    ?>
                                    <label class="btn btn-outline-secondary {{$class[1]}}">
                                        <input type="radio" name="rtpcr_result" id="rtpcr_result_1" value="0" autocomplete="off"> รอผล
                                    </label>
                                    <label class="btn btn-outline-secondary {{$class[2]}}">
                                        <input type="radio" name="rtpcr_result" id="rtpcr_result_2" value="1" autocomplete="off"> Detected
                                    </label>
                                    <label class="btn btn-outline-secondary {{$class[3]}}">
                        ...
                        <tr>
                            <td>
                                ...
                                <div class="input-group btn-group btn-group-sm btn-group-toggle col-12" data-toggle="buttons">
                                    ...
                                    ?>
                                    <label class="btn btn-outline-secondary font-weight-light {{$class[1]}}">
                                        <input type="radio" name="ag_type" id="ag_type_1" value="1" autocomplete="off"> ATK
                                    </label>
                                    <label class="btn btn-outline-secondary font-weight-light {{$class[2]}}">
                                        <input type="radio" name="ag_type" id="ag_type_2" value="2" autocomplete="off"> FIA
                                    </label>
                                    <label class="btn btn-outline-secondary font-weight-light {{$class[3]}}">
                                        <input type="radio" name="ag_type" id="ag_type_3" value="3" autocomplete="off"> ATK ภาคสนาม
                                    </label>
                                </div>
                            </td>
                            <td><input class="form-control" name="ag_date" type="date" value="{{$r->ag_date}}"></td>
                            <td><input class="form-control" name="ag_sample" type="text" value="{{$r->ag_sample}}"></td>
                            <td><input class="form-control" name="ag_labplace" type="text" value="{{$r->ag_labplace}}"></td>
                            <td>
                                <div class="input-group btn-group btn-group-toggle col-12" data-toggle="buttons">
                                    <?php
                                        unset($class);
                        ...
                        <tr>
                            ...
                            <td><input class="form-control" name="ab1_date" type="date" value="{{$r->ab1_date}}"></td>
                            <td><input class="form-control" name="ab1_sample" type="text" value="{{$r->ab1_sample}}"></td>
                            <td><input class="form-control" name="ab1_labplace" type="text" value="{{$r->ab1_labplace}}"></td>
                            <td>
                                <div class="input-group btn-group btn-group-toggle col-12" data-toggle="buttons">
                                    <?php
                                        unset($class);
                                    ...
                                    <label class="btn btn-outline-secondary {{$class[4]}}">
                        ...
                        <tr>
                            ...
                            <td><input class="form-control" name="ab2_date" type="date" value="{{$r->ab2_date}}"></td>
                            <td><input class="form-control" name="ab2_sample" type="text" value="{{$r->ab2_sample}}"></td>
                            <td><input class="form-control" name="ab2_labplace" type="text" value="{{$r->ab2_labplace}}"></td>
                            <td>
                                <div class="input-group btn-group btn-group-toggle col-12" data-toggle="buttons">
                                    <?php
                                        unset($class);
            ...
            <div class="col-9 mb-1">
                <div class="d-flex">
                    ...
                    <div class="input-group btn-group btn-group-toggle col-5" data-toggle="buttons">
                        ...
                        <label class="btn btn-outline-success {{$class[2]}}">
            ...
            <div class="row mb-1">
                <div class="input-group col-lg-12">
                    <div class="input-group">
                        ...
                        {{Form::date('vac1_date', $r->vac1_date, ['class' => 'form-control col-2'])}}
                        <div class="btn-group btn-group-toggle " data-toggle="buttons">
                            ...
                            <label class="btn btn-outline-secondary font-weight-normal {{$class[4]}}">
                            <input type="radio" name="vac1_type" id="vac1_type_4" value="4" autocomplete="off"> Moderna
                            </label>
                        </div>
                        {{Form::text('vac1_place', $r->vac1_place, ['class' => 'form-control col-12', 'placeholder' => 'สถานที่ฉีด'])}}
                    </div>
                </div>
            </div>
            <div class="row mb-1">
                <div class="input-group col-lg-12">
                    <div class="input-group">
                        ...
                        {{Form::date('vac2_date', $r->vac2_date, ['class' => 'form-control col-2'])}}
                        <div class="btn-group btn-group-toggle " data-toggle="buttons">
                            <?php
                                unset($class);
                                $class = [NULL,NULL,NULL,NULL,NULL,NULL];
                        ...
                        {{Form::text('vac2_place', $r->vac2_place, ['class' => 'form-control col-12', 'placeholder' => 'สถานที่ฉีด'])}}
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card col-12">
        ...
        <div class="card-body">
            <div class="form-row">
                <div class="col-6">
                    <div class="form-group">
                        <div class="custom-control custom-switch">
                            ...
                            {{Form::checkbox('rf1', TRUE, $r->rf1, ['id' => 'rf1', 'class' => 'custom-control-input'])}}
                ...
                <div class="col">
                    <div class="input-group">
                        ...
                        {{Form::text('rf1_chw', $r->rf1_chw, ['class' => 'form-control form-control-sm col-3 ', 'placeholder' => 'จังหวัด'])}}
                        <div class="input-group-prepend">
                            <div class="input-group-text form-control-sm">ต่างประเทศ</div>
                        </div>
                        {{Form::text('rf1_country', $r->rf1_country, ['class' => 'form-control form-control-sm col-3 ', 'placeholder' => 'ประเทศ'])}}
                        {{Form::text('rf1_city', $r->rf1_city, ['class' => 'form-control form-control-sm col-3 ', 'placeholder' => 'เมือง'])}}
                    </div>
                </div>
            </div>
            <div class="form-row">
                <div class="col-6">
                    <div class="form-group">
                        <div class="custom-control custom-switch">
                            ...
                            {{Form::checkbox('rf2', TRUE, $r->rf2, ['id' => 'rf2', 'class' => 'custom-control-input'])}}
            ...
            <div class="form-row">
                <div class="col-6">
                    <div class="form-group">
                        <div class="custom-control custom-switch">
                            ...
                            {{Form::checkbox('rf3', TRUE, $r->rf3, ['id' => 'rf3', 'class' => 'custom-control-input'])}}
                ...
                <div class="col">
                    <div class="input-group">
                        {{Form::text('rf3_name', $r->rf3_name, ['class' => 'form-control form-control-sm col-lg-6', 'placeholder' => 'ชื่อผู้ที่สัมผัส'])}}
                    </div>
                </div>
            </div>
            <div class="form-row">
                <div class="col-6">
                    <div class="form-group">
                        <div class="custom-control custom-switch">
                            ...
                            {{Form::checkbox('rf4', TRUE, $r->rf4, ['id' => 'rf4', 'class' => 'custom-control-input'])}}
            ...
            <div class="form-row">
                <div class="col-6">
                    <div class="form-group">
                        <div class="custom-control custom-switch">
                            ...
                            {{Form::checkbox('rf5', TRUE, $r->rf5, ['id' => 'rf5', 'class' => 'custom-control-input'])}}
                ...
                <div class="col">
                    <div class="input-group">
                        {{Form::text('rf5_place', $r->rf5_place, ['class' => 'form-control form-control-sm col-9 ', 'placeholder' => 'ระบุสถานที่'])}}
                    </div>
                </div>
            </div>
            <div class="form-row">
                <div class="col-12">
                    <div class="form-group">
                        <div class="custom-control custom-switch">
                            ...
                            {{Form::checkbox('rf6', TRUE, $r->rf6, ['id' => 'rf6', 'class' => 'custom-control-input'])}}
                ...
                <div class="col-6">
                    <div class="form-group">
                        <div class="custom-control custom-switch">
                            ...
                            {{Form::checkbox('rf7', TRUE, $r->rf7, ['id' => 'rf7', 'class' => 'custom-control-input'])}}
                            {{Form::label('rf7', 'ประวัติเสี่ยงอื่นๆ', ['class' => 'custom-control-label'])}}
                        </div>
                    </div>
                </div>
                <div class="col">
                    {{Form::textarea('rf8_text', $r->rf8_text, ['class' => 'form-control form-control-sm col-lg-12', 'placeholder' => 'ประวัติเสี่ยงอื่นๆ'])}}
                </div>
            </div>
        ...
        <div class="card-body">
            <div class="row mb-1">
                <div class="col-md-3 mb-1 input-group">
                    ...
                    {{Form::number('highrisk_n', $r->highrisk_n, ['class' => 'form-control h-100', 'placeholder' => 'ผู้สัมผัสเสี่ยงสูง'])}}
                    <div class="input-group-append">
                ...
                <div class="col-md-3 mb-1 input-group">
                    ...
                    {{Form::number('highrisk_n_trace', $r->highrisk_n_trace, ['class' => 'form-control h-100', 'placeholder' => 'ตามได้'])}}
                    <div class="input-group-append">
                        <div class="input-group-text text-danger">คน</div>
                    </div>
                </div>
                <div class="col-md-3 mb-1 input-group">
                    <div class="input-group btn-group btn-group-toggle" data-toggle="buttons">
                        <label class="btn btn-outline-secondary d-flex">
                            ...
                            {{Form::number('highrisk_hi', $r->highrisk_hi, ['class' => 'form-control', 'placeholder' => 'จำนวน....คน'])}}
                        </label>
                    </div>
                </div>
                <div class="col-md-3 mb-1 input-group">
                    <div class="input-group btn-group btn-group-toggle" data-toggle="buttons">
                        <label class="btn btn-outline-secondary d-flex text-nowrap">
                            ...
                            {{Form::number('highrisk_ci', $r->highrisk_ci, ['class' => 'form-control', 'placeholder' => 'จำนวน....คน'])}}
                        </label>
                    </div>
                </div>
            </div>
            <div class="row mb-1">
                <div class="col-md-3 mb-1 input-group">
                    ...
                    {{Form::number('lowrisk_n', $r->lowrisk_n, ['class' => 'form-control h-100', 'placeholder' => 'จำนวนผู้สัมผัสเสี่ยงต่ำ'])}}
                    <div class="input-group-append">
                ...
                <div class="col-md-3 mb-1 input-group">
                    ...
                    {{Form::number('lowrisk_n_trace', $r->lowrisk_n_trace, ['class' => 'form-control h-100', 'placeholder' => 'ตามได้'])}}
                    <div class="input-group-append">
                        <div class="input-group-text text-secondary">คน</div>
                    </div>
                </div>
                <div class="col-md-3 mb-1 input-group">
                    <div class="input-group btn-group btn-group-toggle" data-toggle="buttons">
                        <label class="btn btn-outline-secondary d-flex">
                            <input type="radio" autocomplete="off">บ้าน 
                            {{Form::number('lowrisk_hi', $r->lowrisk_hi, ['class' => 'form-control', 'placeholder' => 'จำนวน....คน'])}}
                        </label>
                    </div>
                </div>
                <div class="col-md-3 mb-1 input-group">
                    <div class="input-group btn-group btn-group-toggle" data-toggle="buttons">
                        <label class="btn btn-outline-secondary d-flex text-nowrap">
                            <input type="radio" autocomplete="off">สถานที่กักตัว 
                            {{Form::number('lowrisk_ci', $r->lowrisk_ci, ['class' => 'form-control', 'placeholder' => 'จำนวน....คน'])}}
                        </label>
                    </div>
                </div>
            </div>
